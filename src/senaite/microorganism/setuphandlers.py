...
from senaite.microorganism import PRODUCT_NAME
from senaite.microorganism import PROFILE_ID
from zope.component import getUtility

# Tuples of (folder_id, folder_name, type)
SETUP_FOLDERS = [
    ("microorganisms", "Microorganisms", "MicroorganismFolder"),
    ("microorganism_categories", "Microorganism categories",
...
def setup_handler(context):
    ...
    # Setup folders (Microorganism folder, etc.)
